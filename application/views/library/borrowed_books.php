            ...
            <div class="modal-body">
                <form id="returnForm" method="POST" action="<?= site_url('library/return_book') ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control select2" id="return_btchs" name="return_btch" required>
                    ...
                    <i class="fa-solid fa-triangle-exclamation"></i>
                        <div>
                            <small> Return date is auto generated. <br> Scan Barcode to automatically save the transaction.</small>
                        </div>
                    </div>
...
$(document).ready(function() {
    $('#return_btchs').on('change', function() {
